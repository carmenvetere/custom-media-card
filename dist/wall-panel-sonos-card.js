...
`,St=(t,e,i)=>t.callService("media_player","volume_set",{entity_id:e,volume_level:Math.max(0,Math.min(1,i/100))}),Ct=(t,e,i)=>t.callService("media_player","join",{entity_id:e,group_members:i}),Mt=(t,e)=>t.callService("media_player","unjoin",{entity_id:e}),Pt=Z`<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2 L14.6 8.6 L22 9.3 L16.5 14.2 L18.2 21.5 L12 17.8 L5.8 21.5 L7.5 14.2 L2 9.3 L9.4 8.6 Z"/></svg>`,Tt=Z`<svg width="20" height="22" viewBox="0 0 22 26" fill="none" stroke="currentColor" stroke-width="1.6"><rect x="3" y="2" width="16" height="22" rx="3"/><circle cx="11" cy="16" r="4"/><circle cx="11" cy="7" r="1.3" fill="currentColor"/></svg>`,Rt=Z`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9 L12 15 L18 9"/></svg>`,Ht=Z`<svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M3 9V15H7L12 20V4L7 9H3M14 10.5H23V13.5H14V10.5Z"/></svg>`,Ot=Z`<svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M3 9V15H7L12 20V4L7 9H3M14 13.5V10.5H17V7.5H20V10.5H23V13.5H20V16.5H17V13.5H14Z"/></svg>`,Vt=Z`<svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M14,3.23V5.29C16.89,6.15 19,8.83 19,12C19,15.17 16.89,17.84 14,18.7V20.77C18,19.86 21,16.28 21,12C21,7.72 18,4.14 14,3.23M16.5,12C16.5,10.23 15.5,8.71 14,7.97V16C15.5,15.29 16.5,13.76 16.5,12M3 9H7L12 4V20L7 15H3V9Z"/></svg>`,Lt=Z`<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M6 5 H8 V19 H6 Z M9 12 L20 5 V19 Z"/></svg>`,zt=Z`<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M16 5 H18 V19 H16 Z M4 19 L15 12 L4 5 Z"/></svg>`,jt=Z`<svg width="26" height="26" viewBox="0 0 24 24" fill="currentColor"><path d="M7 5 V19 L19 12 Z"/></svg>`,Ut=Z`<svg width="26" height="26" viewBox="0 0 24 24" fill="currentColor"><rect x="6" y="5" width="4" height="14" rx="1"/><rect x="14" y="5" width="4" height="14" rx="1"/></svg>`,Nt=Z`<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M3 7 H21 V19 H3 Z M3 7 L17 3 V5"/><circle cx="17" cy="13" r="2.5" fill="none" stroke="currentColor" stroke-width="1.4"/></svg>`,Bt=Z`<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="2.2"/></svg>`,Dt=Z`<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M3 6 H15 V8 H3 Z M3 11 H15 V13 H3 Z M3 16 H11 V18 H3 Z M17 11 V20 L21 17 V8 L17 11 Z"/></svg>`,It=Z`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 17 H7 A4 4 0 0 1 7 9 H9 M15 9 H17 A4 4 0 0 1 17 17 H15 M9 13 H15"/></svg>`,Wt=Z`<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12 L10 18 L20 6"/></svg>`,Zt=Z`<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M2 18 H4 V20 H2 Z M7 14 H9 V20 H7 Z M12 10 H14 V20 H12 Z M17 6 H19 V20 H17 Z"/></svg>`,Ft=t=>{(!isFinite(t)||t<0)&&(t=0);return`${Math.floor(t/60)}:${Math.floor(t%60).toString().padStart(2,"0")}`};let Gt=class extends ct{constructor(){super(...arguments),this._view="player",this._activeRoom="",this._userPickedRoom=!1,this._menuOpen=!1,this._favTab="All",this._favQ="",this._dragVol={},this._optimisticPlaying=null,this._loadingName=null,this._now=Date.now(),this._dragTimers={}}static getStubConfig(){return{type:`custom:${At}`,entities:[],default_view:"player",layout:"wall"}}static async getConfigElement(){return await Promise.resolve().then(function(){return Qt}),document.createElement(kt)}setConfig(t){if(!t.entities||!Array.isArray(t.entities)||0===t.entities.length)throw new Error("wall-panel-sonos-card: 'entities' is required and must be a non-empty list of media_player entity IDs.");const e=!this._config;this._config=t,this._activeRoom&&t.entities.includes(this._activeRoom)||(this._activeRoom=t.entities[0]),e&&t.default_view&&(this._view=t.default_view);const i=Math.max(.9,Math.min(1.6,t.track_scale??1.15)),s=Math.max(1,Math.min(2.5,t.vol_bar_scale??1.4));this.style.setProperty("--wp-track-scale",String(i)),this.style.setProperty("--wp-vol-scale",String(s)),"mobile"===t.layout?this.setAttribute("narrow",""):this.removeAttribute("narrow")}getCardSize(){return 8}connectedCallback(){super.connectedCallback(),this._tickHandle=setInterval(()=>{const t=this._state(this._activeRoom);"playing"===t?.state&&"player"===this._view&&(this._now=Date.now())},500)}disconnectedCallback(){super.disconnectedCallback(),this._tickHandle&&clearInterval(this._tickHandle),this._loadingTimer&&clearTimeout(this._loadingTimer);for(const t of Object.values(this._dragTimers))clearTimeout(t);this._dragTimers={}}willUpdate(t){if(!t.has("hass")||!this._config)return;if(!this._userPickedRoom){const t=this._pickActivePlayer();t&&t!==this._activeRoom&&(this._activeRoom=t),this._userPickedRoom=!0}if(null!==this._optimisticPlaying){"playing"===this._state(this._activeRoom)?.state===this._optimisticPlaying&&(this._optimisticPlaying=null)}if(null!==this._loadingName){const t=this._state(this._activeRoom)?.attributes.media_title;t&&t!==this._prevTitle&&(this._loadingName=null,this._loadingTimer&&(clearTimeout(this._loadingTimer),this._loadingTimer=void 0))}let e=null;for(const t of Object.keys(this._dragVol)){if(!this._dragTimers[t])continue;const i=Math.round(100*(this._state(t)?.attributes.volume_level??0));Math.abs(i-this._dragVol[t])<=2&&(e||(e={...this._dragVol}),delete e[t],clearTimeout(this._dragTimers[t]),delete this._dragTimers[t])}e&&(this._dragVol=e)}_state(t){return this.hass?.states[t]}_label(t){return this._config?.names?.[t]??this._state(t)?.attributes.friendly_name??t.replace("media_player.","").replace(/_/g," ")}_groupMembers(){const t=this._state(this._activeRoom);return(t?.attributes.group_members??[this._activeRoom]).filter(t=>this._config.entities.includes(t))}_pickActivePlayer(){const t=this._config.entities;let e=null;for(let i=0;i<t.length;i++){const s=t[i],r=this._state(s);if("playing"!==r?.state)continue;const o=(r.attributes.group_members??[s]).filter(e=>t.includes(e)).length;(!e||o>e.size||o===e.size&&i<e.idx)&&(e={id:s,size:o,idx:i})}return e?.id??null}_setView(t){this._view=this._view===t&&"player"!==t?"player":t,this._menuOpen=!1}_onTitleClick(){"player"!==this._view?this._view="player":this._menuOpen=!this._menuOpen}_pickRoom(t){const e=this._groupMembers();this._activeRoom=t,this._userPickedRoom=!0,this._menuOpen=!1,e.includes(t)||Mt(this.hass,t)}_pickGroup(t){if(0===t.length)return;const e=t[0];this._activeRoom=e,this._userPickedRoom=!0,this._menuOpen=!1,Ct(this.hass,e,t.slice(1))}_onPlayPause(t){var e,i;this._optimisticPlaying=!t,e=this.hass,i=this._activeRoom,e.callService("media_player","media_play_pause",{entity_id:i})}_toggleInGroup(t){if(t===this._activeRoom)return;const e=this._groupMembers();e.includes(t)?Mt(this.hass,t):Ct(this.hass,this._activeRoom,[...e.filter(t=>t!==this._activeRoom),t])}_slide(t,e,i,s){const r=t.currentTarget;s&&this._dragTimers[s]&&(clearTimeout(this._dragTimers[s]),delete this._dragTimers[s]);let o=0,a=null,n=null;const l=t=>{o=Date.now(),a=null,n&&(clearTimeout(n),n=null),i(t)},c=t=>{const i=r.getBoundingClientRect(),c=Math.max(0,Math.min(1,(t.clientX-i.left)/i.width)),d=Math.round(c*e);s&&(this._dragVol={...this._dragVol,[s]:d});const h=Date.now()-o;h>=120?l(d):(a=d,n||(n=setTimeout(()=>{n=null,null!==a&&l(a)},120-h)))};try{r.setPointerCapture(t.pointerId)}catch{}c(t);const d=t=>c(t),h=()=>{r.removeEventListener("pointermove",d),r.removeEventListener("pointerup",h),r.removeEventListener("pointercancel",h);try{r.releasePointerCapture(t.pointerId)}catch{}null!==a&&l(a),n&&(clearTimeout(n),n=null),s&&(this._dragTimers[s]=setTimeout(()=>{if(delete this._dragTimers[s],s in this._dragVol){const t={...this._dragVol};delete t[s],this._dragVol=t}},2e3))};r.addEventListener("pointermove",d),r.addEventListener("pointerup",h),r.addEventListener("pointercancel",h)}render(){if(!this._config||!this.hass)return W``;const t=this._state(this._activeRoom);if(!t)return W`<ha-card><div style="padding:24px;color:var(--wp-text-dim)">Entity ${this._activeRoom} not found.</div></ha-card>`;const e=this._groupMembers(),i=e.length,s="favorites"===this._view?"Favorites":"grouping"===this._view?"Speakers":this._label(this._activeRoom);return W`
    ...
    `}_renderHeader(t,e){return W`
      <div class="hdr">
        ...
        <button class=${wt({"hdr-title":!0,"menu-open":this._menuOpen})}
          ...
          ${"player"===this._view?W`<span class=${wt({chev:!0,up:this._menuOpen})}>${Rt}</span>`:G}
        </button>
    ...
    `}_renderPlayer(t){const e=t.attributes,i=e.media_duration??0,s=this._optimisticPlaying??"playing"===t.state,r=Math.round(100*(e.volume_level??0)),o=this._activeRoom,a=this._maxVol(),n=this._volStep(a),l=o in this._dragVol?this._dragVol[o]:r,c=e.media_position_updated_at?new Date(e.media_position_updated_at).getTime():0,d="playing"===t.state&&c?Math.max(0,(this._now-c)/1e3):0,h=(e.media_position??0)+d,p=i>0?Math.min(i,h):h,u=e.entity_picture?`url("${e.entity_picture}")`:"linear-gradient(135deg, var(--wp-accent) 0%, var(--wp-card-2) 60%, var(--wp-bg) 100%)",g=this._loadingName??e.media_title??"Nothing playing",v=this._loadingName?"Loading…":`${e.media_artist??""}${e.media_album_name?` · ${e.media_album_name}`:""}`;return W`
      <div class="pv">
        ...
        <div class="progress">
          <span>${Ft(p)}</span>
          <div class="bar"><span style=${yt({width:(i>0?p/i*100:0)+"%"})}></span></div>
          <span>${Ft(i)}</span>
        </div>
        <div class="transport">
          <button class="t-btn" @click=${()=>this._stepVol(-n,a)}>${Ht}</button>
          ...
          <button class="t-btn" @click=${()=>this._stepVol(n,a)}>${Ot}</button>
        </div>
        <div class="vol-row">
          <span class="vol-icon">${Vt}</span>
          ${this._slider(l,a,t=>St(this.hass,this._activeRoom,t),this._activeRoom)}
          <span class="vol-num">${l}</span>
        </div>
      </div>
