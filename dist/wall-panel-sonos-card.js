...
`,Mt=(t,e)=>t.callService("media_player","media_play_pause",{entity_id:e}),Pt=(t,e)=>t.callService("media_player","media_next_track",{entity_id:e}),Lt=(t,e,i)=>t.callService("media_player","volume_set",{entity_id:e,volume_level:Math.max(0,Math.min(1,i/100))}),Ht=(t,e,i)=>t.callService("media_player","join",{entity_id:e,group_members:i}),Ot=(t,e)=>t.callService("media_player","unjoin",{entity_id:e}),zt=(t,e,i,s)=>t.callService("media_player","play_media",{entity_id:e,media_content_id:i,media_content_type:s}),Vt=(t,e)=>{const i=t=>{const e=t?.result;return Array.isArray(e)?e:null};if(!t||"object"!=typeof t)return[];const s=t,r=i(s);if(r)return r;const a=s.response;if(a&&"object"==typeof a){const t=i(a);if(t)return t;const s=i(a[e]);if(s)return s;for(const t of Object.keys(a)){const e=i(a[t]);if(e)return e}}const o=i(s[e]);return o||[]},It=t=>`url("${t.replace(/[\r\n"\\]/g,t=>encodeURIComponent(t))}")`,Ut=G`<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2 L14.6 8.6 L22 9.3 L16.5 14.2 L18.2 21.5 L12 17.8 L5.8 21.5 L7.5 14.2 L2 9.3 L9.4 8.6 Z"/></svg>`,jt=G`<svg width="20" height="22" viewBox="0 0 22 26" fill="none" stroke="currentColor" stroke-width="1.6"><rect x="3" y="2" width="16" height="22" rx="3"/><circle cx="11" cy="16" r="4"/><circle cx="11" cy="7" r="1.3" fill="currentColor"/></svg>`,Nt=G`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9 L12 15 L18 9"/></svg>`,Dt=G`<svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M3 9V15H7L12 20V4L7 9H3M14 10.5H23V13.5H14V10.5Z"/></svg>`,Bt=G`<svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M3 9V15H7L12 20V4L7 9H3M14 13.5V10.5H17V7.5H20V10.5H23V13.5H20V16.5H17V13.5H14Z"/></svg>`,Ft=G`<svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M14,3.23V5.29C16.89,6.15 19,8.83 19,12C19,15.17 16.89,17.84 14,18.7V20.77C18,19.86 21,16.28 21,12C21,7.72 18,4.14 14,3.23M16.5,12C16.5,10.23 15.5,8.71 14,7.97V16C15.5,15.29 16.5,13.76 16.5,12M3 9H7L12 4V20L7 15H3V9Z"/></svg>`,Gt=G`<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M6 5 H8 V19 H6 Z M9 12 L20 5 V19 Z"/></svg>`,Wt=G`<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M16 5 H18 V19 H16 Z M4 19 L15 12 L4 5 Z"/></svg>`,Zt=G`<svg width="26" height="26" viewBox="0 0 24 24" fill="currentColor"><path d="M7 5 V19 L19 12 Z"/></svg>`,qt=G`<svg width="26" height="26" viewBox="0 0 24 24" fill="currentColor"><rect x="6" y="5" width="4" height="14" rx="1"/><rect x="14" y="5" width="4" height="14" rx="1"/></svg>`,Qt=G`<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M3 7 H21 V19 H3 Z M3 7 L17 3 V5"/><circle cx="17" cy="13" r="2.5" fill="none" stroke="currentColor" stroke-width="1.4"/></svg>`,Kt=G`<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="2.2"/></svg>`,Yt=G`<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M3 6 H15 V8 H3 Z M3 11 H15 V13 H3 Z M3 16 H11 V18 H3 Z M17 11 V20 L21 17 V8 L17 11 Z"/></svg>`,Jt=G`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 17 H7 A4 4 0 0 1 7 9 H9 M15 9 H17 A4 4 0 0 1 17 17 H15 M9 13 H15"/></svg>`,Xt=G`<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12 L10 18 L20 6"/></svg>`,te=G`<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M2 18 H4 V20 H2 Z M7 14 H9 V20 H7 Z M12 10 H14 V20 H12 Z M17 6 H19 V20 H17 Z"/></svg>`,ee=G`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="7"/><path d="M20 20 L16 16"/></svg>`,ie=G`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round"><path d="M6 6 L18 18 M18 6 L6 18"/></svg>`,se="wall-panel-sonos-mini-card";let re=class extends ct{setConfig(t){if(!t.entities?.length)throw new Error("wall-panel-sonos-mini-card: 'entities' is required.");this._config=t}getCardSize(){return 2}shouldUpdate(t){if(t.size>1||!t.has("hass"))return!0;if(!this._config)return!0;const e=t.get("hass");if(!e)return!0;for(const t of this._config.entities)if(e.states[t]!==this.hass.states[t])return!0;return!1}_state(t){return this.hass?.states[t]}_label(t){return this._config.names?.[t]??this._state(t)?.attributes.friendly_name??t.replace("media_player.","").replace(/_/g," ")}_activeEntity(){return this._config.entities.find(t=>"playing"===this._state(t)?.state)??this._config.entities.find(t=>["paused","buffering"].includes(this._state(t)?.state??""))}_coordinatorMeta(t,e){if(e)for(const i of e){if(i===t)continue;const e=this._state(i)?.attributes;if(e&&(e.media_title||e.entity_picture))return e}}_stationArt(t){if(!t||!this._config.station_art?.length)return;const e=t.toLowerCase();return this._config.station_art.find(t=>t.match&&e.includes(t.match.toLowerCase()))}_sourceFromContentId(t){if(!t)return;const e=t.match(/[?&]source=([^&]+)/i);return e?decodeURIComponent(e[1]):void 0}_navigate(){const t=this._config.navigation_path;t&&(history.pushState(null,"",t),this.dispatchEvent(new Event("location-changed",{composed:!0})))}render(){if(!this.hass||!this._config)return F``;const t=this._activeEntity();if(!t)return F``;const e=this._state(t),i=e.attributes,s=i.media_title||i.entity_picture?i:this._coordinatorMeta(t,i.group_members)??i,r=s.media_content_id??i.media_content_id,a=this._stationArt(r),o="playing"===e.state,n=Math.round(100*(i.volume_level??0)),l=this._config.volume_step??5,c=a?.image?It(a.image):s.entity_picture?It(s.entity_picture):"linear-gradient(135deg, #6a4ec8 0%, #1e3a6e 60%, #0a1428 100%)",d=s.media_title??a?.name??s.app_name??i.app_name??this._sourceFromContentId(r)??(o?"Playing":"—"),h=i.group_members?.length??1,p=`${this._label(t)}${h>1?" +"+(h-1):""}`;return F`
      <ha-card>
        <div class="root">
          <div class="hdr">
          ...
          <div class="body">
            ...
            <div class="ctrls">
              <button class="btn" @click=${()=>Lt(this.hass,t,Math.max(0,n-l))}>${Dt}</button>
              <button class="btn primary" @click=${()=>Mt(this.hass,t)}>
                ${o?qt:Zt}
              </button>
              <button class="btn" @click=${()=>Lt(this.hass,t,Math.min(100,n+l))}>${Bt}</button>
              <button class="btn" @click=${()=>Pt(this.hass,t)}>${Wt}</button>
            </div>
          </div>
        </div>
      </ha-card>
  ...
  `,t([vt({attribute:!1})],re.prototype,"hass",void 0),t([gt()],re.prototype,"_config",void 0),re=t([ht(se)],re),window.customCards=window.customCards||[],window.customCards.push({type:se,name:"Wall Panel Sonos Mini Card",description:"Compact now-playing tile — pairs with wall-panel-sonos-card.",preview:!1});const ae=t=>{(!isFinite(t)||t<0)&&(t=0);return`${Math.floor(t/60)}:${Math.floor(t%60).toString().padStart(2,"0")}`};let oe=class extends ct{constructor(){super(...arguments),this._view="player",this._activeRoom="",this._userPickedRoom=!1,this._menuOpen=!1,this._favTab="All",this._favQ="",this._dragVol={},this._optimisticPlaying=null,this._loadingName=null,this._skipping=!1,this._toast=null,this._searchQ="",this._searchResults=[],this._searchLoading=!1,this._searchError=null,this._searchGen=0,this._now=Date.now(),this._dragTimers={}}static getStubConfig(){return{type:`custom:${Ct}`,entities:[],default_view:"player",layout:"wall"}}static async getConfigElement(){return await Promise.resolve().then(function(){return le}),document.createElement(Et)}setConfig(t){if(!t.entities||!Array.isArray(t.entities)||0===t.entities.length)throw new Error("wall-panel-sonos-card: 'entities' is required and must be a non-empty list of media_player entity IDs.");const e=!this._config;this._config=t,this._activeRoom&&t.entities.includes(this._activeRoom)||(this._activeRoom=t.entities[0]),e&&t.default_view&&(this._view=t.default_view);const i=Math.max(.9,Math.min(1.6,t.track_scale??1.15)),s=Math.max(1,Math.min(2.5,t.vol_bar_scale??1.4));this.style.setProperty("--wp-track-scale",String(i)),this.style.setProperty("--wp-vol-scale",String(s)),"mobile"===t.layout?this.setAttribute("narrow",""):this.removeAttribute("narrow")}getCardSize(){return 8}connectedCallback(){super.connectedCallback(),this._tickHandle=setInterval(()=>{if("visible"!==document.visibilityState)return;if("player"!==this._view)return;const t=this._state(this._activeRoom);"playing"===t?.state&&(this._now=Date.now())},500)}disconnectedCallback(){super.disconnectedCallback(),this._tickHandle&&clearInterval(this._tickHandle),this._loadingTimer&&clearTimeout(this._loadingTimer),this._skipTimer&&clearTimeout(this._skipTimer),this._optimisticPlayingTimer&&clearTimeout(this._optimisticPlayingTimer),this._toastTimer&&clearTimeout(this._toastTimer),this._searchDebounce&&clearTimeout(this._searchDebounce);for(const t of Object.values(this._dragTimers))clearTimeout(t);this._dragTimers={}}_svc(t,e){return t.catch(t=>{const i=t instanceof Error?t.message:String(t);this._showToast(`${e} — ${i}`)})}_showToast(t){this._toast={message:t,kind:"error"},this._toastTimer&&clearTimeout(this._toastTimer),this._toastTimer=setTimeout(()=>{this._toast=null},5e3)}shouldUpdate(t){if(t.size>1||!t.has("hass"))return!0;if(!this._config)return!0;const e=t.get("hass");if(!e)return!0;for(const t of this._config.entities)if(e.states[t]!==this.hass.states[t])return!0;return!1}willUpdate(t){if(!t.has("hass")||!this._config)return;if(!this._userPickedRoom){const t=this._pickActivePlayer();t&&(t!==this._activeRoom&&(this._activeRoom=t),this._userPickedRoom=!0)}if(null!==this._optimisticPlaying){"playing"===this._state(this._activeRoom)?.state===this._optimisticPlaying&&(this._optimisticPlaying=null,this._optimisticPlayingTimer&&(clearTimeout(this._optimisticPlayingTimer),this._optimisticPlayingTimer=void 0))}if(null!==this._loadingName){const t=this._state(this._activeRoom)?.attributes.media_title;t&&t!==this._prevTitle&&(this._loadingName=null,this._loadingTimer&&(clearTimeout(this._loadingTimer),this._loadingTimer=void 0))}if(this._skipping){const t=this._state(this._activeRoom)?.attributes.media_title;t&&t!==this._prevTitle&&(this._skipping=!1,this._skipTimer&&(clearTimeout(this._skipTimer),this._skipTimer=void 0))}let e=null;for(const t of Object.keys(this._dragVol)){if(!this._dragTimers[t])continue;const i=Math.round(100*(this._state(t)?.attributes.volume_level??0));Math.abs(i-this._dragVol[t])<=2&&(e||(e={...this._dragVol}),delete e[t],clearTimeout(this._dragTimers[t]),delete this._dragTimers[t])}e&&(this._dragVol=e)}_state(t){return this.hass?.states[t]}_label(t){return this._config?.names?.[t]??this._state(t)?.attributes.friendly_name??t.replace("media_player.","").replace(/_/g," ")}_groupMembers(){const t=this._state(this._activeRoom);return(t?.attributes.group_members??[this._activeRoom]).filter(t=>this._config.entities.includes(t))}_coordinatorMeta(t){if(t)for(const e of t){if(e===this._activeRoom)continue;const t=this._state(e)?.attributes;if(t&&(t.media_title||t.entity_picture))return t}}_stationArt(t){if(!t||!this._config?.station_art?.length)return;const e=t.toLowerCase();return this._config.station_art.find(t=>t.match&&e.includes(t.match.toLowerCase()))}_sourceFromContentId(t){if(!t)return;const e=t.match(/[?&]source=([^&]+)/i);return e?decodeURIComponent(e[1]):void 0}_pickActivePlayer(){const t=this._config.entities;let e=null;for(let i=0;i<t.length;i++){const s=t[i],r=this._state(s);if("playing"!==r?.state)continue;const a=(r.attributes.group_members??[s]).filter(e=>t.includes(e)).length;(!e||a>e.size||a===e.size&&i<e.idx)&&(e={id:s,size:a,idx:i})}return e?.id??null}_setView(t){this._view=this._view===t&&"player"!==t?"player":t,this._menuOpen=!1}_onTitleClick(){"player"!==this._view?this._view="player":this._menuOpen=!this._menuOpen}_pickRoom(t){const e=this._groupMembers();this._activeRoom=t,this._userPickedRoom=!0,this._menuOpen=!1,e.includes(t)||this._svc(Ot(this.hass,t),`Couldn't ungroup ${this._label(t)}`)}_pickGroup(t){if(0===t.length)return;const e=t[0];this._activeRoom=e,this._userPickedRoom=!0,this._menuOpen=!1,this._svc(Ht(this.hass,e,t.slice(1)),`Couldn't create group "${this._label(e)}"`)}_onPlayPause(t){this._optimisticPlaying=!t,this._optimisticPlayingTimer&&clearTimeout(this._optimisticPlayingTimer),this._optimisticPlayingTimer=setTimeout(()=>{this._optimisticPlaying=null},5e3),this._svc(Mt(this.hass,this._activeRoom),`Couldn't ${t?"pause":"resume"} ${this._label(this._activeRoom)}`)}_onSkip(t){this._prevTitle=this._state(this._activeRoom)?.attributes.media_title,this._skipping=!0,this._skipTimer&&clearTimeout(this._skipTimer),this._skipTimer=setTimeout(()=>{this._skipping=!1},5e3);const e="next"===t?Pt(this.hass,this._activeRoom):(i=this.hass,s=this._activeRoom,i.callService("media_player","media_previous_track",{entity_id:s}));var i,s;this._svc(e,"Couldn't skip "+("next"===t?"forward":"back"))}_toggleInGroup(t){if(t===this._activeRoom)return;const e=this._groupMembers();e.includes(t)?this._svc(Ot(this.hass,t),`Couldn't remove ${this._label(t)} from the group`):this._svc(Ht(this.hass,this._activeRoom,[...e.filter(t=>t!==this._activeRoom),t]),`Couldn't add ${this._label(t)} to the group`)}_slide(t,e,i,s){const r=t.currentTarget;s&&this._dragTimers[s]&&(clearTimeout(this._dragTimers[s]),delete this._dragTimers[s]);let a=0,o=null,n=null;const l=t=>{a=Date.now(),o=null,n&&(clearTimeout(n),n=null),i(t)},c=t=>{const i=r.getBoundingClientRect(),c=Math.max(0,Math.min(1,(t.clientX-i.left)/i.width)),d=Math.round(c*e);s&&(this._dragVol={...this._dragVol,[s]:d});const h=Date.now()-a;h>=120?l(d):(o=d,n||(n=setTimeout(()=>{n=null,null!==o&&l(o)},120-h)))};try{r.setPointerCapture(t.pointerId)}catch{}c(t);const d=t=>c(t),h=()=>{r.removeEventListener("pointermove",d),r.removeEventListener("pointerup",h),r.removeEventListener("pointercancel",h);try{r.releasePointerCapture(t.pointerId)}catch{}null!==o&&l(o),n&&(clearTimeout(n),n=null),s&&(this._dragTimers[s]=setTimeout(()=>{if(delete this._dragTimers[s],s in this._dragVol){const t={...this._dragVol};delete t[s],this._dragVol=t}},2e3))};r.addEventListener("pointermove",d),r.addEventListener("pointerup",h),r.addEventListener("pointercancel",h)}render(){if(!this._config||!this.hass)return F``;const t=this._state(this._activeRoom);if(!t)return F`<ha-card><div style="padding:24px;color:var(--wp-text-dim)">Entity ${this._activeRoom} not found.</div></ha-card>`;const e=this._groupMembers(),i=e.length,s="favorites"===this._view?"Favorites":"grouping"===this._view?"Speakers":"search"===this._view?"Search":this._label(this._activeRoom);return F`
    ...
    `}_renderHeader(t,e){const i=!1!==this._config.search_enabled;return F`
      <div class="hdr">
        ...
        <button class=${xt({"hdr-title":!0,"menu-open":this._menuOpen})}
          ...
          ${"player"===this._view?F`<span class=${xt({chev:!0,up:this._menuOpen})}>${Nt}</span>`:Z}
        </button>
    ...
    `}_renderPlayer(t){const e=t.attributes,i=e.media_title||e.entity_picture?e:this._coordinatorMeta(e.group_members)??e,s=i.media_duration??0,r=this._optimisticPlaying??"playing"===t.state,a=Math.round(100*(e.volume_level??0)),o=this._activeRoom,n=this._maxVol(),l=this._volStep(n),c=o in this._dragVol?this._dragVol[o]:a,d=i.media_position_updated_at?new Date(i.media_position_updated_at).getTime():0,h="playing"===t.state&&d?Math.max(0,(this._now-d)/1e3):0,p=(i.media_position??0)+h,u=s>0?Math.min(s,p):p,v=i.media_content_id??e.media_content_id,g=this._stationArt(v),m=g?.image?It(g.image):i.entity_picture?It(i.entity_picture):"linear-gradient(135deg, var(--wp-accent) 0%, var(--wp-card-2) 60%, var(--wp-bg) 100%)",_="playing"===t.state,f=this._loadingName??i.media_title??g?.name??(_?i.app_name??e.app_name??"Playing":"Nothing playing"),b=this._loadingName||this._skipping?"Loading…":`${i.media_artist??""}${i.media_album_name?` · ${i.media_album_name}`:""}`,w=e.source??this._sourceFromContentId(v);return F`
      <div class="pv">
        ...
        <div class="progress">
          <span>${ae(u)}</span>
          <div class="bar"><span style=${kt({width:(s>0?u/s*100:0)+"%"})}></span></div>
          <span>${ae(s)}</span>
        </div>
        <div class="transport">
          <button class="t-btn" @click=${()=>this._stepVol(-l,n)}>${Dt}</button>
          <button class="t-btn" @click=${()=>this._onSkip("prev")}>${Gt}</button>
          <button class="play-btn" @click=${()=>this._onPlayPause(r)}>
            ${r?qt:Zt}
          </button>
          <button class="t-btn" @click=${()=>this._onSkip("next")}>${Wt}</button>
          <button class="t-btn" @click=${()=>this._stepVol(l,n)}>${Bt}</button>
        </div>
        <div class="vol-row">
          <span class="vol-icon">${Ft}</span>
          ${this._slider(c,n,t=>Lt(this.hass,this._activeRoom,t),this._activeRoom)}
          <span class="vol-num">${c}</span>
        </div>
      </div>
    `}_maxVol(){const t=this._config?.max_volume??100;return Math.max(1,Math.min(100,Math.round(t)))}_volStep(t){return Math.max(1,Math.round(t/20))}_stepVol(t,e){const i=this._activeRoom,s=i in this._dragVol?this._dragVol[i]:Math.round(100*(this._state(i)?.attributes.volume_level??0)),r=Math.max(0,Math.min(e,s+t));r!==s&&(this._dragVol={...this._dragVol,[i]:r},this._dragTimers[i]&&clearTimeout(this._dragTimers[i]),this._dragTimers[i]=setTimeout(()=>{if(delete this._dragTimers[i],i in this._dragVol){const t={...this._dragVol};delete t[i],this._dragVol=t}},2e3),Lt(this.hass,i,r))}_slider(t,e,i,s){const r=s&&s in this._dragVol?this._dragVol[s]:t,a=e>0?Math.max(0,Math.min(100,r/e*100)):0;return F`
      <div class="slider" @pointerdown=${t=>this._slide(t,e,i,s)}>
        <div class="fill" style=${kt({width:`${a}%`})}></div>
        <div class="knob" style=${kt({left:`${a}%`})}></div>
      </div>
    ...
    `}_playFavorite(t){t.script?this._svc(((t,e,i={})=>{const s=e.startsWith("script.")?e.slice(7):e;return t.callService("script",s,i)})(this.hass,t.script,{entity_id:this._activeRoom,group_members:this._groupMembers()}),`Couldn't run ${t.script} for "${t.name}"`):t.media_content_id&&t.media_content_type&&this._svc(zt(this.hass,this._activeRoom,t.media_content_id,t.media_content_type),`Couldn't play "${t.name}"`),this._prevTitle=this._state(this._activeRoom)?.attributes.media_title,this._loadingName=t.name,this._loadingTimer&&clearTimeout(this._loadingTimer),this._loadingTimer=setTimeout(()=>{this._loadingName=null},8e3),this._view="player"}_onSearchInput(t){this._searchQ=t,this._searchDebounce&&clearTimeout(this._searchDebounce);const e=t.trim();if(!e)return this._searchResults=[],this._searchError=null,this._searchLoading=!1,void this._searchGen++;this._searchDebounce=setTimeout(()=>this._runSearch(e),350)}async _runSearch(t){const e=++this._searchGen;this._searchLoading=!0,this._searchError=null;try{const i=await(async(t,e,i)=>{const s=await t.callWS({type:"call_service",domain:"media_player",service:"search_media",service_data:{entity_id:e,search_query:i},target:{entity_id:e},return_response:!0}),r=Vt(s,e);return r.length||console.debug("[wall-panel-sonos-card] search_media returned no items; raw response:",s),r})(this.hass,this._activeRoom,t);if(e!==this._searchGen)return;this._searchResults=i.slice(0,60)}catch(t){if(e!==this._searchGen)return;const i=t instanceof Error?t.message:String(t);this._searchError=/unknown_service|not\s*found/i.test(i)?"Search not supported on this Home Assistant version.":i,this._searchResults=[]}finally{e===this._searchGen&&(this._searchLoading=!1)}}_playSearchResult(t){if(!t.media_content_id)return;const e=t.media_content_type??t.media_class??"music";this._svc(zt(this.hass,this._activeRoom,t.media_content_id,e),`Couldn't play "${t.title}"`),this._prevTitle=this._state(this._activeRoom)?.attributes.media_title,this._loadingName=t.title,this._loadingTimer&&clearTimeout(this._loadingTimer),this._loadingTimer=setTimeout(()=>{this._loadingName=null},8e3),this._view="player"}_renderSearch(){const t=this._groupMembers().length,e=this._searchResults;return F`
      <div class="pv pv-scroll">
        <div class="fav-target">
        ...
        <div class="search-bar">
          ...
          ${this._searchQ?F`
            <button class="search-clear" aria-label="Clear"
              @click=${()=>this._onSearchInput("")}>${ie}</button>
          `:Z}
        </div>
      ...
      <div class="pv pv-scroll">
        ...
        <div class="grp-grid">
          ${e.map(e=>{const i=e===this._activeRoom,s=(e=>t.includes(e))(e);return F`
              <button class=${xt({"grp-row":!0,primary:i,grouped:s&&!i})}
                      @click=${()=>this._toggleInGroup(e)}>
                <span style="display:flex;align-items:center;gap:8px;flex:1;min-width:0">
                  ${i?F`<span style="display:flex">${te}</span>`:Z}
                  <span style="white-space:nowrap;overflow:hidden;text-overflow:ellipsis">${this._label(e)}</span>
                </span>
                ${i?F`<span class="badge">PRIMARY</span>`:s?F`<span style="width:20px;height:20px;border-radius:50%;background:rgba(255,255,255,0.6);display:flex;align-items:center;justify-content:center;color:var(--wp-bg)">${Xt}</span>`:Z}
              </button>
            `})}
        </div>
        ${t.length>1?F`
          <div class="grp-volumes">
            ...
            ${t.map(t=>{const e=Math.round(100*(this._state(t)?.attributes.volume_level??0));return F`
                <div class="grp-vol-row">
                  ...
                  ${this._slider(e,100,e=>Lt(this.hass,t,e),t)}
    ...
    `}};oe.styles=Rt,t([vt({attribute:!1})],oe.prototype,"hass",void 0),t([gt()],oe.prototype,"_config",void 0),t([gt()],oe.prototype,"_view",void 0),t([gt()],oe.prototype,"_activeRoom",void 0),t([gt()],oe.prototype,"_menuOpen",void 0),t([gt()],oe.prototype,"_favTab",void 0),t([gt()],oe.prototype,"_favQ",void 0),t([gt()],oe.prototype,"_dragVol",void 0),t([gt()],oe.prototype,"_optimisticPlaying",void 0),t([gt()],oe.prototype,"_loadingName",void 0),t([gt()],oe.prototype,"_skipping",void 0),t([gt()],oe.prototype,"_toast",void 0),t([gt()],oe.prototype,"_searchQ",void 0),t([gt()],oe.prototype,"_searchResults",void 0),t([gt()],oe.prototype,"_searchLoading",void 0),t([gt()],oe.prototype,"_searchError",void 0),t([gt()],oe.prototype,"_now",void 0),oe=t([ht(Ct)],oe),window.customCards=window.customCards||[],window.customCards.push({type:Ct,name:"Wall Panel Sonos Card",description:"Sonos multi-room control designed for wall-mounted tablets.",preview:!1,documentationURL:"https://github.com/your-org/wall-panel-sonos-card"});let ne=class extends ct{constructor(){super(...arguments),this._open="rooms",this._openItem={},this._renderRooms=()=>{const t=this._config.entities??[],e=this._config.names??{},i=this._entityOptions().filter(e=>!t.includes(e));return F`
      ${t.map((i,s)=>F`
        <div class="item">
          <div class="item-head">
  ...
  `,this._renderFavorites=()=>{const t=this._config.favorites??[],e=this._scriptOptions();return F`
    ...
    `}_updateFav(t,e){const i=(this._config.favorites??[]).map((i,s)=>s===t?{...i,...e}:i);this._setList("favorites",i)}_updateGroup(t,e){const i=(this._config.groups??[]).map((i,s)=>s===t?{...i,...e}:i);this._setList("groups",i)}_updateStationArt(t,e){const i=(this._config.station_art??[]).map((i,s)=>s===t?{...i,...e}:i);this._setList("station_art",i)}};ne.styles=o`
    :host { display: block; }
    .sec {
  ...
  `,t([vt({attribute:!1})],ne.prototype,"hass",void 0),t([gt()],ne.prototype,"_config",void 0),t([gt()],ne.prototype,"_open",void 0),t([gt()],ne.prototype,"_openItem",void 0),ne=t([ht(Et)],ne);var le=Object.freeze({__proto__:null,get WallPanelSonosCardEditor(){return ne}});export{Tt as CARD_VERSION,oe as WallPanelSonosCard};
