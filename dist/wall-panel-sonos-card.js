...
`,Rt=(t,e)=>t.callService("media_player","media_play_pause",{entity_id:e}),Lt=(t,e)=>t.callService("media_player","media_next_track",{entity_id:e}),Pt=(t,e,i)=>t.callService("media_player","volume_set",{entity_id:e,volume_level:Math.max(0,Math.min(1,i/100))}),Ot=(t,e,i)=>t.callService("media_player","join",{entity_id:e,group_members:i}),Ht=(t,e)=>t.callService("media_player","unjoin",{entity_id:e}),Vt=(t,e,i,s)=>t.callService("media_player","play_media",{entity_id:e,media_content_id:i,media_content_type:s}),zt=(t,e)=>{const i=t=>{const e=t?.result;return Array.isArray(e)?e:null};if(!t||"object"!=typeof t)return[];const s=t,a=i(s);if(a)return a;const r=s.response;if(r&&"object"==typeof r){const t=i(r);if(t)return t;const s=i(r[e]);if(s)return s;for(const t of Object.keys(r)){const e=i(r[t]);if(e)return e}}const o=i(s[e]);return o||[]},Ft=(t,e,i,s)=>t.callWS({type:"media_player/browse_media",entity_id:e,...i?{media_content_id:i}:{},...s?{media_content_type:s}:{}}),It=async(t,e,i=8)=>{const s=await t.callWS({type:"config_entries/get",domain:"music_assistant"}),a=s?.[0];if(!a)throw new Error("Music Assistant integration not found");const r=await t.callWS({type:"call_service",domain:"music_assistant",service:"search",service_data:{config_entry_id:a.entry_id,name:e,limit:i},return_response:!0}),o=r?.response??r,n=[],l=["tracks","artists","albums","playlists","radio","podcasts","audiobooks"];for(const t of l){const e=o?.[t];if(Array.isArray(e))for(const i of e){const e=i.uri??i.media_content_id,s=i.name??i.title;"string"==typeof e&&"string"==typeof s&&n.push({title:s,media_content_id:e,media_content_type:i.media_type??"music",media_class:t.replace(/s$/,""),thumbnail:i.image??void 0})}}return n},Ut=t=>`url("${t.replace(/[\r\n"\\]/g,t=>encodeURIComponent(t))}")`,jt=B`<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2 L14.6 8.6 L22 9.3 L16.5 14.2 L18.2 21.5 L12 17.8 L5.8 21.5 L7.5 14.2 L2 9.3 L9.4 8.6 Z"/></svg>`,Nt=B`<svg width="20" height="22" viewBox="0 0 22 26" fill="none" stroke="currentColor" stroke-width="1.6"><rect x="3" y="2" width="16" height="22" rx="3"/><circle cx="11" cy="16" r="4"/><circle cx="11" cy="7" r="1.3" fill="currentColor"/></svg>`,Dt=B`<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9 L12 15 L18 9"/></svg>`,Gt=B`<svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M3 9V15H7L12 20V4L7 9H3M14 10.5H23V13.5H14V10.5Z"/></svg>`,Bt=B`<svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M3 9V15H7L12 20V4L7 9H3M14 13.5V10.5H17V7.5H20V10.5H23V13.5H20V16.5H17V13.5H14Z"/></svg>`,Wt=B`<svg width="22" height="22" viewBox="0 0 24 24" fill="currentColor"><path d="M14,3.23V5.29C16.89,6.15 19,8.83 19,12C19,15.17 16.89,17.84 14,18.7V20.77C18,19.86 21,16.28 21,12C21,7.72 18,4.14 14,3.23M16.5,12C16.5,10.23 15.5,8.71 14,7.97V16C15.5,15.29 16.5,13.76 16.5,12M3 9H7L12 4V20L7 15H3V9Z"/></svg>`,Zt=B`<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M6 5 H8 V19 H6 Z M9 12 L20 5 V19 Z"/></svg>`,qt=B`<svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M16 5 H18 V19 H16 Z M4 19 L15 12 L4 5 Z"/></svg>`,Qt=B`<svg width="26" height="26" viewBox="0 0 24 24" fill="currentColor"><path d="M7 5 V19 L19 12 Z"/></svg>`,Yt=B`<svg width="26" height="26" viewBox="0 0 24 24" fill="currentColor"><rect x="6" y="5" width="4" height="14" rx="1"/><rect x="14" y="5" width="4" height="14" rx="1"/></svg>`,Kt=B`<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M3 7 H21 V19 H3 Z M3 7 L17 3 V5"/><circle cx="17" cy="13" r="2.5" fill="none" stroke="currentColor" stroke-width="1.4"/></svg>`,Jt=B`<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="2.2"/></svg>`,Xt=B`<svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor"><path d="M3 6 H15 V8 H3 Z M3 11 H15 V13 H3 Z M3 16 H11 V18 H3 Z M17 11 V20 L21 17 V8 L17 11 Z"/></svg>`,te=B`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 17 H7 A4 4 0 0 1 7 9 H9 M15 9 H17 A4 4 0 0 1 17 17 H15 M9 13 H15"/></svg>`,ee=B`<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"><path d="M4 12 L10 18 L20 6"/></svg>`,ie=B`<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M2 18 H4 V20 H2 Z M7 14 H9 V20 H7 Z M12 10 H14 V20 H12 Z M17 6 H19 V20 H17 Z"/></svg>`,se=B`<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"><circle cx="11" cy="11" r="7"/><path d="M20 20 L16 16"/></svg>`,ae=B`<svg width="22" height="22" viewBox="0 0 24 24"><path fill="currentColor" d="M3 9V15H7L12 20V4L7 9H3"/><path stroke="currentColor" stroke-width="2.4" stroke-linecap="round" fill="none" d="M15.5 9.5 L21 15 M21 9.5 L15.5 15"/></svg>`,re=B`<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round"><path d="M6 6 L18 18 M18 6 L6 18"/></svg>`,oe="wall-panel-sonos-mini-card";let ne=class extends ct{setConfig(t){if(!t.entities?.length)throw new Error("wall-panel-sonos-mini-card: 'entities' is required.");this._config=t}getCardSize(){return 2}shouldUpdate(t){if(t.size>1||!t.has("hass"))return!0;if(!this._config)return!0;const e=t.get("hass");if(!e)return!0;for(const t of this._config.entities)if(e.states[t]!==this.hass.states[t])return!0;return!1}_state(t){return this.hass?.states[t]}_label(t){return this._config.names?.[t]??this._state(t)?.attributes.friendly_name??t.replace("media_player.","").replace(/_/g," ")}_activeEntity(){return this._config.entities.find(t=>"playing"===this._state(t)?.state)??this._config.entities.find(t=>["paused","buffering"].includes(this._state(t)?.state??""))}_coordinatorMeta(t,e){if(e)for(const i of e){if(i===t)continue;const e=this._state(i)?.attributes;if(e&&(e.media_title||e.entity_picture))return e}}_stationArt(t){if(!t||!this._config.station_art?.length)return;const e=t.toLowerCase();return this._config.station_art.find(t=>t.match&&e.includes(t.match.toLowerCase()))}_sourceFromContentId(t){if(!t)return;const e=t.match(/[?&]source=([^&]+)/i);return e?decodeURIComponent(e[1]):void 0}_navigate(){const t=this._config.navigation_path;t&&(history.pushState(null,"",t),this.dispatchEvent(new Event("location-changed",{composed:!0})))}render(){if(!this.hass||!this._config)return G``;const t=this._activeEntity();if(!t)return G``;const e=this._state(t),i=e.attributes,s=i.media_title||i.entity_picture?i:this._coordinatorMeta(t,i.group_members)??i,a=s.media_content_id??i.media_content_id,r=this._stationArt(a),o="playing"===e.state,n=Math.round(100*(i.volume_level??0)),l=this._config.volume_step??5,c=r?.image?Ut(r.image):s.entity_picture?Ut(s.entity_picture):"linear-gradient(135deg, #6a4ec8 0%, #1e3a6e 60%, #0a1428 100%)",d=s.media_title??r?.name??s.app_name??i.app_name??this._sourceFromContentId(a)??(o?"Playing":"—"),h=i.group_members?.length??1,p=`${this._label(t)}${h>1?" +"+(h-1):""}`;return G`
      <ha-card>
        <div class="root">
          <div class="hdr">
          ...
          <div class="body">
            ...
            <div class="ctrls">
              <button class="btn" aria-label="Volume down"
                @click=${()=>Pt(this.hass,t,Math.max(0,n-l))}>${Gt}</button>
              <button class="btn primary" aria-label=${o?"Pause":"Play"}
                @click=${()=>Rt(this.hass,t)}>
                ${o?Yt:Qt}
              </button>
              <button class="btn" aria-label="Volume up"
                @click=${()=>Pt(this.hass,t,Math.min(100,n+l))}>${Bt}</button>
              <button class="btn" aria-label="Next track"
                @click=${()=>Lt(this.hass,t)}>${qt}</button>
            </div>
          </div>
        </div>
      </ha-card>
  ...
  `,t([vt({attribute:!1})],ne.prototype,"hass",void 0),t([_t()],ne.prototype,"_config",void 0),ne=t([ht(oe)],ne),window.customCards=window.customCards||[],window.customCards.push({type:oe,name:"Wall Panel Sonos Mini Card",description:"Compact now-playing tile — pairs with wall-panel-sonos-card.",preview:!1});const ce=t=>{(!isFinite(t)||t<0)&&(t=0);return`${Math.floor(t/60)}:${Math.floor(t%60).toString().padStart(2,"0")}`};let de=le=class extends ct{constructor(){super(...arguments),this._view="player",this._activeRoom="",this._userPickedRoom=!1,this._menuOpen=!1,this._favTab="All",this._favQ="",this._dragVol={},this._optimisticPlaying=null,this._optimisticMuted=null,this._pendingGroup={},this._pendingGroupTimers={},this._shared=null,this._sharedAttempted=!1,this._maFavs=null,this._maFavsLoading=!1,this._maFavsError=null,this._maFavsFetchedAt=0,this._loadingName=null,this._skipping=!1,this._toast=null,this._searchQ="",this._searchResults=[],this._searchLoading=!1,this._searchError=null,this._searchGen=0,this._now=Date.now(),this._dragTimers={}}static getStubConfig(){return{type:`custom:${Mt}`,entities:[],default_view:"player",layout:"wall"}}static async getConfigElement(){return await Promise.resolve().then(function(){return pe}),document.createElement(Ct)}setConfig(t){if(!t.entities||!Array.isArray(t.entities)||0===t.entities.length)throw new Error("wall-panel-sonos-card: 'entities' is required and must be a non-empty list of media_player entity IDs.");const e=!this._config;this._config=t,this._activeRoom&&t.entities.includes(this._activeRoom)||(this._activeRoom=t.entities[0]),e&&t.default_view&&(this._view=t.default_view);const i=Math.max(.9,Math.min(1.6,t.track_scale??1.15)),s=Math.max(1,Math.min(2.5,t.vol_bar_scale??1.4));this.style.setProperty("--wp-track-scale",String(i)),this.style.setProperty("--wp-vol-scale",String(s)),"mobile"===t.layout?this.setAttribute("narrow",""):this.removeAttribute("narrow")}getCardSize(){return 8}connectedCallback(){super.connectedCallback(),this._tickHandle=setInterval(()=>{if("visible"!==document.visibilityState)return;if("player"!==this._view)return;const t=this._state(this._activeRoom);"playing"===t?.state&&(this._now=Date.now())},500)}disconnectedCallback(){super.disconnectedCallback(),this._tickHandle&&clearInterval(this._tickHandle),this._loadingTimer&&clearTimeout(this._loadingTimer),this._skipTimer&&clearTimeout(this._skipTimer),this._optimisticPlayingTimer&&clearTimeout(this._optimisticPlayingTimer),this._toastTimer&&clearTimeout(this._toastTimer),this._searchDebounce&&clearTimeout(this._searchDebounce),this._optimisticMutedTimer&&clearTimeout(this._optimisticMutedTimer);for(const t of Object.values(this._pendingGroupTimers))clearTimeout(t);this._pendingGroupTimers={};for(const t of Object.values(this._dragTimers))clearTimeout(t);this._dragTimers={},this._sharedUnsub?.(),this._sharedUnsub=void 0,this._sharedAttempted=!1}async _connectSharedStore(){if(!this._sharedAttempted&&this._config?.use_shared_store&&this.hass){this._sharedAttempted=!0;try{this._sharedUnsub=await this.hass.connection.subscribeMessage(t=>{this._shared=t},{type:"wall_panel_sonos/subscribe"})}catch{console.warn("[wall-panel-sonos-card] use_shared_store is on but the wall_panel_sonos integration didn't respond — using the card's YAML lists instead.")}}}_instant(t){return e=>{const i=e.currentTarget;if("pointerdown"===e.type){const s=e;if("mouse"===s.pointerType&&0!==s.button)return;i._wpPressed=!0,setTimeout(()=>{i._wpPressed=!1},400),t()}else i._wpPressed?i._wpPressed=!1:t()}}_svc(t,e){return t.catch(t=>{const i=t instanceof Error?t.message:String(t);this._showToast(`${e} — ${i}`)})}_showToast(t){this._toast={message:t,kind:"error"},this._toastTimer&&clearTimeout(this._toastTimer),this._toastTimer=setTimeout(()=>{this._toast=null},5e3)}shouldUpdate(t){if(t.size>1||!t.has("hass"))return!0;if(!this._config)return!0;const e=t.get("hass");if(!e)return!0;for(const t of this._config.entities)if(e.states[t]!==this.hass.states[t])return!0;return!1}willUpdate(t){if(!t.has("hass")||!this._config)return;if(this._connectSharedStore(),"favorites"===this._view&&"music_assistant"===this._config.favorites_source&&this._fetchMaFavorites(),!this._userPickedRoom){const t=this._pickActivePlayer();t&&(t!==this._activeRoom&&(this._activeRoom=t),this._userPickedRoom=!0)}if(null!==this._optimisticPlaying){"playing"===this._state(this._activeRoom)?.state===this._optimisticPlaying&&(this._optimisticPlaying=null,this._optimisticPlayingTimer&&(clearTimeout(this._optimisticPlayingTimer),this._optimisticPlayingTimer=void 0))}if(null!==this._optimisticMuted){!!this._state(this._activeRoom)?.attributes.is_volume_muted===this._optimisticMuted&&(this._optimisticMuted=null,this._optimisticMutedTimer&&(clearTimeout(this._optimisticMutedTimer),this._optimisticMutedTimer=void 0))}if(Object.keys(this._pendingGroup).length){const t=this._state(this._activeRoom)?.attributes.group_members??[this._activeRoom];let e=null;for(const[i,s]of Object.entries(this._pendingGroup))t.includes(i)===s&&(e||(e={...this._pendingGroup}),delete e[i],this._pendingGroupTimers[i]&&(clearTimeout(this._pendingGroupTimers[i]),delete this._pendingGroupTimers[i]));e&&(this._pendingGroup=e)}if(null!==this._loadingName){const t=this._state(this._activeRoom)?.attributes.media_title;t&&t!==this._prevTitle&&(this._loadingName=null,this._loadingTimer&&(clearTimeout(this._loadingTimer),this._loadingTimer=void 0))}if(this._skipping){const t=this._state(this._activeRoom)?.attributes.media_title;t&&t!==this._prevTitle&&(this._skipping=!1,this._skipTimer&&(clearTimeout(this._skipTimer),this._skipTimer=void 0))}let e=null;for(const t of Object.keys(this._dragVol)){if(!this._dragTimers[t])continue;const i=Math.round(100*(this._state(t)?.attributes.volume_level??0));Math.abs(i-this._dragVol[t])<=2&&(e||(e={...this._dragVol}),delete e[t],clearTimeout(this._dragTimers[t]),delete this._dragTimers[t])}e&&(this._dragVol=e)}_state(t){return this.hass?.states[t]}_label(t){return this._config?.names?.[t]??this._state(t)?.attributes.friendly_name??t.replace("media_player.","").replace(/_/g," ")}_groupMembers(){const t=this._state(this._activeRoom);return(t?.attributes.group_members??[this._activeRoom]).filter(t=>this._config.entities.includes(t))}_coordinatorMeta(t){if(t)for(const e of t){if(e===this._activeRoom)continue;const t=this._state(e)?.attributes;if(t&&(t.media_title||t.entity_picture))return t}}_favoritesList(){return(this._config.use_shared_store?this._shared?.favorites:void 0)??this._config.favorites??[]}_groupsList(){return(this._config.use_shared_store?this._shared?.groups:void 0)??this._config.groups??[]}_stationArtList(){return(this._config.use_shared_store?this._shared?.station_art:void 0)??this._config.station_art??[]}_maEntity(t){return this._config.ma_entities?.[t]}_anyMaEntity(){const t=this._config.ma_entities??{};return t[this._activeRoom]??Object.values(t)[0]}async _fetchMaFavorites(t=!1){if(this._maFavsLoading)return;const e=Date.now()-this._maFavsFetchedAt<le.MA_FAVS_TTL_MS;if(!t&&this._maFavs&&e)return;if(!t&&this._maFavsError&&e)return;const i=this._anyMaEntity();if(!i)return this._maFavsError="favorites_source is music_assistant but no ma_entities are mapped.",void(this._maFavsFetchedAt=Date.now());this._maFavsLoading=!0,this._maFavsError=null;try{const t=await Ft(this.hass,i),e=[[/playlist/i,"playlist"],[/radio|station/i,"station"],[/album/i,"album"]],s=[];for(const a of t.children??[]){const t=e.find(([t])=>t.test(a.title)||t.test(a.media_content_id??""));if(!t||!a.can_expand)continue;const r=await Ft(this.hass,i,a.media_content_id,a.media_content_type);for(const e of r.children??[])e.can_play&&e.media_content_id&&s.push({title:e.title,media_content_id:e.media_content_id,media_content_type:e.media_content_type,thumbnail:e.thumbnail,category:t[1]})}this._maFavs=s,this._maFavsFetchedAt=Date.now()}catch(t){this._maFavsError=`Couldn't browse Music Assistant: ${t instanceof Error?t.message:t}`,this._maFavsFetchedAt=Date.now()}finally{this._maFavsLoading=!1}}_playMaFavorite(t){const e=this._maEntity(this._activeRoom);e?(this._svc(Vt(this.hass,e,t.media_content_id,t.media_content_type??"music"),`Couldn't play "${t.title}"`),this._prevTitle=this._state(this._activeRoom)?.attributes.media_title,this._loadingName=t.title,this._loadingTimer&&clearTimeout(this._loadingTimer),this._loadingTimer=setTimeout(()=>{this._loadingName=null},8e3),this._view="player"):this._showToast(`${this._label(this._activeRoom)} has no ma_entities mapping — add one to play Music Assistant favorites there.`)}_stationArt(t){const e=this._stationArtList();if(!t||!e.length)return;const i=t.toLowerCase();return e.find(t=>t.match&&i.includes(t.match.toLowerCase()))}_sourceFromContentId(t){if(!t)return;const e=t.match(/[?&]source=([^&]+)/i);return e?decodeURIComponent(e[1]):void 0}_pickActivePlayer(){const t=this._config.entities;let e=null;for(let i=0;i<t.length;i++){const s=t[i],a=this._state(s);if("playing"!==a?.state)continue;const r=(a.attributes.group_members??[s]).filter(e=>t.includes(e)).length;(!e||r>e.size||r===e.size&&i<e.idx)&&(e={id:s,size:r,idx:i})}return e?.id??null}_setView(t){this._view=this._view===t&&"player"!==t?"player":t,this._menuOpen=!1,"favorites"===this._view&&"music_assistant"===this._config?.favorites_source&&this._fetchMaFavorites()}_onTitleClick(){"player"!==this._view?this._view="player":this._menuOpen=!this._menuOpen}_pickRoom(t){const e=this._groupMembers();this._activeRoom=t,this._userPickedRoom=!0,this._menuOpen=!1,this._optimisticMuted=null,this._optimisticPlaying=null,e.includes(t)||this._svc(Ht(this.hass,t),`Couldn't ungroup ${this._label(t)}`)}_pickGroup(t){if(0===t.length)return;const e=t[0];this._activeRoom=e,this._userPickedRoom=!0,this._menuOpen=!1,this._optimisticMuted=null,this._optimisticPlaying=null,this._svc(Ot(this.hass,e,t.slice(1)),`Couldn't create group "${this._label(e)}"`)}_onPlayPause(t){this._optimisticPlaying=!t,this._optimisticPlayingTimer&&clearTimeout(this._optimisticPlayingTimer),this._optimisticPlayingTimer=setTimeout(()=>{this._optimisticPlaying=null},5e3),this._svc(Rt(this.hass,this._activeRoom),`Couldn't ${t?"pause":"resume"} ${this._label(this._activeRoom)}`)}_onSkip(t){this._prevTitle=this._state(this._activeRoom)?.attributes.media_title,this._skipping=!0,this._skipTimer&&clearTimeout(this._skipTimer),this._skipTimer=setTimeout(()=>{this._skipping=!1},5e3);const e="next"===t?Lt(this.hass,this._activeRoom):(i=this.hass,s=this._activeRoom,i.callService("media_player","media_previous_track",{entity_id:s}));var i,s;this._svc(e,"Couldn't skip "+("next"===t?"forward":"back"))}_toggleInGroup(t){if(t===this._activeRoom)return;const e=this._groupMembers(),i=!e.includes(t);this._pendingGroup={...this._pendingGroup,[t]:i},this._pendingGroupTimers[t]&&clearTimeout(this._pendingGroupTimers[t]),this._pendingGroupTimers[t]=setTimeout(()=>{if(delete this._pendingGroupTimers[t],t in this._pendingGroup){const e={...this._pendingGroup};delete e[t],this._pendingGroup=e}},6e3),i?this._svc(Ot(this.hass,this._activeRoom,[...e.filter(t=>t!==this._activeRoom),t]),`Couldn't add ${this._label(t)} to the group`):this._svc(Ht(this.hass,t),`Couldn't remove ${this._label(t)} from the group`)}_onMuteToggle(){const t=this._optimisticMuted??!!this._state(this._activeRoom)?.attributes.is_volume_muted;var e,i,s;this._optimisticMuted=!t,this._optimisticMutedTimer&&clearTimeout(this._optimisticMutedTimer),this._optimisticMutedTimer=setTimeout(()=>{this._optimisticMuted=null},5e3),this._svc((e=this.hass,i=this._activeRoom,s=t,e.callService("media_player","volume_mute",{entity_id:i,is_volume_muted:!s})),`Couldn't ${t?"unmute":"mute"} ${this._label(this._activeRoom)}`)}_slide(t,e,i,s){const a=t.currentTarget;s&&this._dragTimers[s]&&(clearTimeout(this._dragTimers[s]),delete this._dragTimers[s]);let r=0,o=null,n=null;const l=t=>{r=Date.now(),o=null,n&&(clearTimeout(n),n=null),i(t)},c=t=>{const i=a.getBoundingClientRect(),c=Math.max(0,Math.min(1,(t.clientX-i.left)/i.width)),d=Math.round(c*e);s&&(this._dragVol={...this._dragVol,[s]:d});const h=Date.now()-r;h>=120?l(d):(o=d,n||(n=setTimeout(()=>{n=null,null!==o&&l(o)},120-h)))};try{a.setPointerCapture(t.pointerId)}catch{}c(t);const d=t=>c(t),h=()=>{a.removeEventListener("pointermove",d),a.removeEventListener("pointerup",h),a.removeEventListener("pointercancel",h);try{a.releasePointerCapture(t.pointerId)}catch{}null!==o&&l(o),n&&(clearTimeout(n),n=null),s&&(this._dragTimers[s]=setTimeout(()=>{if(delete this._dragTimers[s],s in this._dragVol){const t={...this._dragVol};delete t[s],this._dragVol=t}},2e3))};a.addEventListener("pointermove",d),a.addEventListener("pointerup",h),a.addEventListener("pointercancel",h)}render(){if(!this._config||!this.hass)return G``;const t=this._state(this._activeRoom);if(!t)return G`<ha-card><div style="padding:24px;color:var(--wp-text-dim)">Entity ${this._activeRoom} not found.</div></ha-card>`;const e=this._groupMembers(),i=e.length,s="favorites"===this._view?"Favorites":"grouping"===this._view?"Speakers":"search"===this._view?"Search":this._label(this._activeRoom);return G`
      <ha-card>
        <div class="root">
    ...
    `}_renderHeader(t,e){const i=!1!==this._config.search_enabled;return G`
      <div class="hdr">
        <div class="hdr-side left">
          <button class=${yt({"hdr-btn":!0,active:"favorites"===this._view})}
                  @click=${()=>this._setView("favorites")}
                  aria-label="Favorites" aria-pressed=${"favorites"===this._view}>
            ${jt}
          </button>
        </div>
        <button class=${yt({"hdr-title":!0,"menu-open":this._menuOpen})}
                @click=${this._onTitleClick}>
          <span>${t}</span>
          ${"player"===this._view&&e>1?G`<span class="group-pill">+${e-1}</span>`:Z}
          ${"player"===this._view?G`<span class=${yt({chev:!0,up:this._menuOpen})}>${Dt}</span>`:Z}
        </button>
        <div class="hdr-side right">
          ${i?G`
            <button class=${yt({"hdr-btn":!0,active:"search"===this._view})}
                    @click=${()=>this._setView("search")}
                    aria-label="Search" aria-pressed=${"search"===this._view}>
              ${se}
            </button>
          `:Z}
          <button class=${yt({"hdr-btn":!0,active:"grouping"===this._view})}
    ...
    `}_renderPlayer(t){const e=t.attributes,i=e.media_title||e.entity_picture?e:this._coordinatorMeta(e.group_members)??e,s=i.media_duration??0,a=this._optimisticPlaying??"playing"===t.state,r=this._optimisticMuted??!!e.is_volume_muted,o=Math.round(100*(e.volume_level??0)),n=this._activeRoom,l=this._maxVol(),c=this._volStep(l),d=n in this._dragVol?this._dragVol[n]:o,h=i.media_position_updated_at?new Date(i.media_position_updated_at).getTime():0,p="playing"===t.state&&h?Math.max(0,(this._now-h)/1e3):0,u=(i.media_position??0)+p,v=s>0?Math.min(s,u):u,_=i.media_content_id??e.media_content_id,m=this._stationArt(_),g=m?.image?Ut(m.image):i.entity_picture?Ut(i.entity_picture):"linear-gradient(135deg, var(--wp-accent) 0%, var(--wp-card-2) 60%, var(--wp-bg) 100%)",f="playing"===t.state,b=this._loadingName??i.media_title??m?.name??(f?i.app_name??e.app_name??"Playing":"Nothing playing"),w=this._loadingName||this._skipping?"Loading…":`${i.media_artist??""}${i.media_album_name?` · ${i.media_album_name}`:""}`,y=e.source??this._sourceFromContentId(_);return G`
      <div class="pv">
        <div class="src">
          ${y?G`<span class="src-dot"></span>${y}`:Z}
        </div>
        <div class="cover-wrap">
          <div class="cover" style=${kt({backgroundImage:g})}></div>
        </div>
        <div class="meta">
        ...
        <div class="transport">
          ${(()=>{const t=this._instant(()=>this._stepVol(-c,l)),e=this._instant(()=>this._onSkip("prev")),i=this._instant(()=>this._onPlayPause(a)),s=this._instant(()=>this._onSkip("next")),r=this._instant(()=>this._stepVol(c,l));return G`
              <button class="t-btn" aria-label="Volume down"
                @pointerdown=${t} @click=${t}>${Gt}</button>
              <button class="t-btn" aria-label="Previous track"
                @pointerdown=${e} @click=${e}>${Zt}</button>
              <button class="play-btn" aria-label=${a?"Pause":"Play"}
                @pointerdown=${i} @click=${i}>
                ${a?Yt:Qt}
              </button>
              <button class="t-btn" aria-label="Next track"
                @pointerdown=${s} @click=${s}>${qt}</button>
              <button class="t-btn" aria-label="Volume up"
                @pointerdown=${r} @click=${r}>${Bt}</button>
            `})()}
        </div>
        <div class=${yt({"vol-row":!0,muted:r})}>
          ${(()=>{const t=this._instant(()=>this._onMuteToggle());return G`
            ...
            `})()}
          ${this._slider(d,l,t=>Pt(this.hass,this._activeRoom,t),this._activeRoom,`Volume for ${this._label(this._activeRoom)}`)}
          <span class="vol-num">${d}</span>
        </div>
      </div>
    `}_maxVol(){const t=this._config?.max_volume??100;return Math.max(1,Math.min(100,Math.round(t)))}_volStep(t){return Math.max(1,Math.round(t/20))}_stepVol(t,e){const i=this._activeRoom,s=i in this._dragVol?this._dragVol[i]:Math.round(100*(this._state(i)?.attributes.volume_level??0)),a=Math.max(0,Math.min(e,s+t));a!==s&&(this._dragVol={...this._dragVol,[i]:a},this._dragTimers[i]&&clearTimeout(this._dragTimers[i]),this._dragTimers[i]=setTimeout(()=>{if(delete this._dragTimers[i],i in this._dragVol){const t={...this._dragVol};delete t[i],this._dragVol=t}},2e3),Pt(this.hass,i,a))}_slider(t,e,i,s,a="Volume"){const r=s&&s in this._dragVol?this._dragVol[s]:t,o=e>0?Math.max(0,Math.min(100,r/e*100)):0;return G`
        ...
        <div class="fav-target">
          ...
          ${t?G`
            <button class="fav-refresh" aria-label="Refresh from Music Assistant"
              @click=${()=>this._fetchMaFavorites(!0)}>↻</button>
          `:Z}
        </div>
        <div class="tabs" role="tablist" aria-label="Favorite categories">
          ${["All","Playlists","Stations","Albums"].map(t=>G`
            <button class=${yt({tab:!0,active:this._favTab===t})}
                    role="tab" aria-selected=${this._favTab===t}
                    @click=${()=>this._favTab=t}>${t}</button>
          `)}
        </div>
        <div class="fav-list">
          ${t?this._renderMaFavList(i):this._renderConfigFavList(i)}
        </div>
      </div>
    `}_renderConfigFavList(t){const e=this._favoritesList().filter(e=>(!t||e.type===t)&&!(this._favQ&&!e.name.toLowerCase().includes(this._favQ.toLowerCase())));return 0===e.length?G`<div class="fav-empty">No favorites configured</div>`:e.map(t=>G`
      <button class="fav-item" @click=${()=>this._playFavorite(t)}>
        <span class="fav-art" style=${kt({background:t.art??"linear-gradient(135deg,#4a5d72,#2a3540)"})}>
          ${"station"===t.type?Kt:"album"===t.type?Jt:Xt}
        </span>
        <span class="fav-label">${t.name}</span>
      </button>
    `)}_renderMaFavList(t){if(this._maFavsError)return G`<div class="fav-empty error">${this._maFavsError}</div>`;if(!this._maFavs)return G`<div class="fav-empty">Loading Music Assistant library…</div>`;const e=this._maFavs.filter(e=>(!t||e.category===t)&&!(this._favQ&&!e.title.toLowerCase().includes(this._favQ.toLowerCase())));return 0===e.length?G`<div class="fav-empty">Nothing in the Music Assistant library${t?` under ${this._favTab}`:""}. Favorite items in MA's UI and they appear here.</div>`:e.map(t=>G`
      <button class="fav-item" @click=${()=>this._playMaFavorite(t)}>
        <span class="fav-art" style=${kt({background:t.thumbnail?Ut(t.thumbnail):"linear-gradient(135deg,#4a5d72,#2a3540)"})}>
          ${t.thumbnail?Z:"station"===t.category?Kt:"album"===t.category?Jt:Xt}
        </span>
        <span class="fav-label">${t.title}</span>
      </button>
    `)}_playFavorite(t){t.script?this._svc(((t,e,i={})=>{const s=e.startsWith("script.")?e.slice(7):e;return t.callService("script",s,i)})(this.hass,t.script,{entity_id:this._activeRoom,group_members:this._groupMembers()}),`Couldn't run ${t.script} for "${t.name}"`):t.media_content_id&&t.media_content_type&&this._svc(Vt(this.hass,this._activeRoom,t.media_content_id,t.media_content_type),`Couldn't play "${t.name}"`),this._prevTitle=this._state(this._activeRoom)?.attributes.media_title,this._loadingName=t.name,this._loadingTimer&&clearTimeout(this._loadingTimer),this._loadingTimer=setTimeout(()=>{this._loadingName=null},8e3),this._view="player"}_onSearchInput(t){this._searchQ=t,this._searchDebounce&&clearTimeout(this._searchDebounce);const e=t.trim();if(!e)return this._searchResults=[],this._searchError=null,this._searchLoading=!1,void this._searchGen++;this._searchDebounce=setTimeout(()=>this._runSearch(e),350)}async _runSearch(t){const e=++this._searchGen;this._searchLoading=!0,this._searchError=null;const i=this._maEntity(this._activeRoom)??this._activeRoom,s=!!this._anyMaEntity();try{let a=await(async(t,e,i)=>{const s=await t.callWS({type:"call_service",domain:"media_player",service:"search_media",service_data:{entity_id:e,search_query:i},target:{entity_id:e},return_response:!0}),a=zt(s,e);return a.length||console.debug("[wall-panel-sonos-card] search_media returned no items; raw response:",s),a})(this.hass,i,t);if(!a.length&&s&&(a=await It(this.hass,t)),e!==this._searchGen)return;this._searchResults=a.slice(0,60)}catch(i){if(e!==this._searchGen)return;if(s)try{const i=await It(this.hass,t);if(e!==this._searchGen)return;return void(this._searchResults=i.slice(0,60))}catch{}const a=i instanceof Error?i.message:String(i);this._searchError=/unknown_service|not\s*found/i.test(a)?"Search not supported on this Home Assistant version.":a,this._searchResults=[]}finally{e===this._searchGen&&(this._searchLoading=!1)}}_playSearchResult(t){if(!t.media_content_id)return;const e=t.media_content_type??t.media_class??"music",i=this._maEntity(this._activeRoom)??this._activeRoom;this._svc(Vt(this.hass,i,t.media_content_id,e),`Couldn't play "${t.title}"`),this._prevTitle=this._state(this._activeRoom)?.attributes.media_title,this._loadingName=t.title,this._loadingTimer&&clearTimeout(this._loadingTimer),this._loadingTimer=setTimeout(()=>{this._loadingName=null},8e3),this._view="player"}_renderSearch(){const t=this._groupMembers().length,e=this._searchResults;return G`
      <div class="pv pv-scroll">
        <div class="fav-target">
          Play to <b>${this._label(this._activeRoom)}${t>1?" +"+(t-1):""}</b>
        </div>
        <div class="search-bar">
          <span class="search-icon">${se}</span>
          ...
          ${this._searchQ?G`
            <button class="search-clear" aria-label="Clear"
              @click=${()=>this._onSearchInput("")}>${re}</button>
          `:Z}
        </div>
        <div class="search-list">
          ${this._searchError?G`<div class="search-empty error">${this._searchError}</div>`:this._searchLoading?G`<div class="search-empty">Searching…</div>`:this._searchQ?0===e.length?G`<div class="search-empty">No results.</div>`:e.map(t=>G`
                    <button class="search-item" @click=${()=>this._playSearchResult(t)}>
                      <span class="search-art"
                        style=${kt({background:t.thumbnail?Ut(t.thumbnail):"linear-gradient(135deg, var(--wp-accent) 0%, var(--wp-card-2) 100%)"})}>
                        ${t.thumbnail?Z:"album"===t.media_class?Jt:"playlist"===t.media_class?Xt:Kt}
                      </span>
                  ...
                  `):G`<div class="search-empty">Type to search across Sonos and connected services.</div>`}
        </div>
      </div>
    `}_renderGrouping(t){const e=this._config.entities,i=e=>this._pendingGroup[e]??t.includes(e),s=e.filter(t=>t===this._activeRoom||i(t));return G`
      <div class="pv pv-scroll">
        ...
        <div class="grp-grid">
          ${e.map(t=>{const e=t===this._activeRoom,s=i(t),a=t in this._pendingGroup;return G`
              <button class=${yt({"grp-row":!0,primary:e,grouped:s&&!e,pending:a})}
                      aria-pressed=${s}
                      aria-label="${this._label(t)}${e?", primary speaker":s?", in group":", not in group"}"
                      @click=${()=>this._toggleInGroup(t)}>
                <span style="display:flex;align-items:center;gap:8px;flex:1;min-width:0">
                  ${e?G`<span style="display:flex">${ie}</span>`:Z}
                  <span style="white-space:nowrap;overflow:hidden;text-overflow:ellipsis">${this._label(t)}</span>
                </span>
                ${e?G`<span class="badge">PRIMARY</span>`:s?G`<span style="width:20px;height:20px;border-radius:50%;background:var(--wp-on-accent-soft);display:flex;align-items:center;justify-content:center;color:var(--wp-bg)">${ee}</span>`:Z}
              </button>
            `})}
        </div>
        ${s.length>1?G`
          <div class="grp-volumes">
            ...
            ${s.map(t=>{const e=Math.round(100*(this._state(t)?.attributes.volume_level??0));return G`
                <div class="grp-vol-row">
                  <span class="name">${this._label(t)}${t===this._activeRoom?G`<span style="color:var(--wp-accent)"> ·</span>`:Z}</span>
                  ${this._slider(e,100,e=>Pt(this.hass,t,e),t,`Volume for ${this._label(t)}`)}
    ...
    `}_renderMenu(t){const e=this._groupsList(),i=[...t].sort().join(",");return G`
      <div class="menu-overlay" @click=${()=>this._menuOpen=!1}
        ...
        <div class="menu-card" role="dialog" aria-label="Rooms and groups"
          ...
          ${t.length>1||e.length>0?G`<div class="menu-section">Groups</div>`:Z}
          ${t.length>1?G`
            <button class="menu-item active">
              <span style="display:flex">${te}</span>
              <span style="flex:1">${t.map(t=>this._label(t)).join(" + ")}</span>
              <span class="now-pill">NOW</span>
            </button>
          `:Z}
          ${e.filter(t=>{const e=t.entities.filter(t=>this._config.entities.includes(t));return[...e].sort().join(",")!==i}).map(t=>G`
          ...
          ${this._config.entities.map(e=>{const i=e===this._activeRoom&&1===t.length,s=t.includes(e)&&t.length>1;return G`
              <button class=${yt({"menu-item":!0,active:i})}
                      @click=${()=>this._pickRoom(e)}>
                <span style="display:flex">${Nt}</span>
                <span style="flex:1">${this._label(e)}</span>
                ${s?G`<span class="group-pill">IN GROUP</span>`:Z}
              </button>
            `})}
        </div>
      </div>
    `}};de.styles=Et,de.MA_FAVS_TTL_MS=3e5,t([vt({attribute:!1})],de.prototype,"hass",void 0),t([_t()],de.prototype,"_config",void 0),t([_t()],de.prototype,"_view",void 0),t([_t()],de.prototype,"_activeRoom",void 0),t([_t()],de.prototype,"_menuOpen",void 0),t([_t()],de.prototype,"_favTab",void 0),t([_t()],de.prototype,"_favQ",void 0),t([_t()],de.prototype,"_dragVol",void 0),t([_t()],de.prototype,"_optimisticPlaying",void 0),t([_t()],de.prototype,"_optimisticMuted",void 0),t([_t()],de.prototype,"_pendingGroup",void 0),t([_t()],de.prototype,"_shared",void 0),t([_t()],de.prototype,"_maFavs",void 0),t([_t()],de.prototype,"_maFavsLoading",void 0),t([_t()],de.prototype,"_maFavsError",void 0),t([_t()],de.prototype,"_loadingName",void 0),t([_t()],de.prototype,"_skipping",void 0),t([_t()],de.prototype,"_toast",void 0),t([_t()],de.prototype,"_searchQ",void 0),t([_t()],de.prototype,"_searchResults",void 0),t([_t()],de.prototype,"_searchLoading",void 0),t([_t()],de.prototype,"_searchError",void 0),t([_t()],de.prototype,"_now",void 0),de=le=t([ht(Mt)],de),window.customCards=window.customCards||[],window.customCards.push({type:Mt,name:"Wall Panel Sonos Card",description:"Sonos multi-room control designed for wall-mounted tablets.",preview:!1,documentationURL:"https://github.com/your-org/wall-panel-sonos-card"});let he=class extends ct{constructor(){super(...arguments),this._open="rooms",this._openItem={},this._renderRooms=()=>{const t=this._config.entities??[],e=this._config.names??{},i=this._entityOptions().filter(e=>!t.includes(e));return G`
      ${t.map((i,s)=>G`
        <div class="item">
          <div class="item-head">
          ...
          <div class="item-body">
            ...
            <div class="row">
              ...
              <select @change=${t=>{const e=t.target.value,s={...this._config.ma_entities??{}};e?s[i]=e:delete s[i],this._emit({...this._config,ma_entities:Object.keys(s).length?s:void 0})}}>
                <option value="">— none —</option>
                ${this._entityOptions().filter(t=>t!==i).map(t=>G`
                  <option value=${t} ?selected=${this._config.ma_entities?.[i]===t}>${t}</option>
                `)}
              </select>
      ...
      <div class="adder">
        <select @change=${e=>{const i=e.target.value;i&&(this._setList("entities",[...t,i]),e.target.value="")}}>
          ...
          ${i.map(t=>G`<option value=${t}>${t}</option>`)}
        </select>
      </div>
    `},this._renderOptions=()=>G`
    <div class="row">
      <label>Default view</label>
      <select @change=${t=>this._val("default_view",t.target.value)}>
        ${["player","favorites","search","grouping"].map(t=>G`
    ...
    <div class="row">
      ...
      <select @change=${t=>this._val("favorites_source",t.target.value)}>
        <option value="config" ?selected=${"config"===(this._config.favorites_source??"config")}>config (YAML / shared store)</option>
        <option value="music_assistant" ?selected=${"music_assistant"===this._config.favorites_source}>music_assistant (live library)</option>
      </select>
  ...
  `,this._renderFavorites=()=>{const t=this._config.favorites??[],e=this._scriptOptions();return G`
      ${t.map((i,s)=>{const a=`fav:${s}`,r=!!this._openItem[a],o=i.script?"script":"media";return G`
          <div class="item">
            ...
            ${r?G`
              <div class="item-body">
                ...
                <div class="row">
                  <label>Type</label>
                  <div class="chip-list">
                    ${["playlist","station","album"].map(t=>G`
                ...
                `:G`
                  <div class="row">
                    ...
                    <select
                      ...
                      ${e.map(t=>G`<option value=${t} ?selected=${i.script===t}>${t}</option>`)}
                    </select>
    ...
    `},this._renderGroups=()=>{const t=this._config.groups??[],e=this._config.entities??[];return G`
      ${t.map((i,s)=>{const a=`grp:${s}`,r=!!this._openItem[a];return G`
          <div class="item">
            <div class="item-head" @click=${()=>this._toggleItem(a)}>
              <span>${r?"▾":"▸"}</span>
            ...
            ${r?G`
              <div class="item-body">
                ...
                <div class="row">
                  <label>Rooms</label>
                  <div class="chip-list">
                    ${0===e.length?G`<div class="help">Add rooms in the Rooms section first.</div>`:e.map(t=>{const e=(i.entities??[]).includes(t);return G`
    ...
    `},this._renderStationArt=()=>{const t=this._config.station_art??[];return G`
      ${t.map((e,i)=>{const s=`art:${i}`,a=!!this._openItem[s];return G`
          <div class="item">
    ...
    `:G``}_renderSection(t,e,i,s){const a=this._open===t;return G`
      <div class="sec">
        <div class="sec-head" @click=${()=>this._toggleSection(t)}>
          <span>${a?"▾":"▸"} ${e}</span>
          <span class="count">${i}</span>
        </div>
        ${a?G`<div class="sec-body">${s.call(this)}</div>`:Z}
      </div>
    `}_updateFav(t,e){const i=(this._config.favorites??[]).map((i,s)=>s===t?{...i,...e}:i);this._setList("favorites",i)}_updateGroup(t,e){const i=(this._config.groups??[]).map((i,s)=>s===t?{...i,...e}:i);this._setList("groups",i)}_updateStationArt(t,e){const i=(this._config.station_art??[]).map((i,s)=>s===t?{...i,...e}:i);this._setList("station_art",i)}};he.styles=o`
    :host { display: block; }
    .sec {
  ...
  `,t([vt({attribute:!1})],he.prototype,"hass",void 0),t([_t()],he.prototype,"_config",void 0),t([_t()],he.prototype,"_open",void 0),t([_t()],he.prototype,"_openItem",void 0),he=t([ht(Ct)],he);var pe=Object.freeze({__proto__:null,get WallPanelSonosCardEditor(){return he}});export{St as CARD_VERSION,de as WallPanelSonosCard};
